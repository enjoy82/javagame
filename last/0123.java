...
class ClickModel extends Observable implements ActionListener{
  ...
  protected int haveobject[]; //現在保有しているアイテムの数(4個)クリックあたりに増える系
  protected int haveobject2[]; //現在保有しているアイテムの数(4個)秒数増える系
...
class ViewPanel extends JPanel implements Observer {
    ...
    private JLabel label_nowclick, label_persec, label_perclick,  num_persec,num_perclick;
    ...
    public ViewPanel(ClickModel m) {
        ...
        label_persec = new JLabel("per second : ");
        label_persec.setHorizontalAlignment(JLabel.CENTER);
        label_perclick = new JLabel("per click : ");
        ...
        p1.add(num_perclick);
	    p1.setBackground(new Color(0,51,153));
        p2 = new JPanel();
        p2.setLayout(new GridLayout(2,1));
        this.add(p1);
        p2.add(label_nowclick);
